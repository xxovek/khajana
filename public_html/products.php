      ...
      <div class="main-content">
        <div class="row">
          ...
          <div class="col-6 col-lg-6">
            <div class="flexbox flex-justified text-center bg-white">
              <div class="no-shrink py-30">
                <a href="#" class="fa fa-cart-arrow-down fs-50" id="BtnLowStock" onclick="displayLowStockItems();" style="color: #ff8000">
                <span  class="fs-40" id="LowStkQty" style="color: #ff8000"></span>  </a>
          ...
          <div class="col-6 col-lg-6">
            ...
            <div class="flexbox flex-justified text-center bg-white">
              <div class="no-shrink py-30">
                <a  href="#" class="fa fa-times-circle fs-50" id="BtnOutStock" onclick="displayOutStockItems();" style="color: #d52b1e">
                <span class="fs-40" id="OutStkQty"></span></a>
            ...
            <table class="table table-striped table-bordered" cellspacing="0"   id="tblData">
              <thead>
                <tr>
                  ...
                  <th style="width:10%">Low Stock Alert</th>
