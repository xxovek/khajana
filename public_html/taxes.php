  ...
  <body class="sidebar-folded">
    ...
    <main>
      <header class="header bg-ui-general">
        <div class="header-action">
          <nav class="nav">
            ...
            <a class="nav-link active" href="#">Taxes</a>
      ...
      <div class="main-content">
        ...
        <div class="card">
          <h4 class="card-title"><strong>Taxes</strong>  Information</h4>
    ...
    <div class="fab fab-fixed">
      <a class="btn btn-float btn-primary" href="#qv-Taxes-addDiv" title="New Tax" data-provide="tooltip" data-toggle="quickview" id="newTaxesFormBtn"><i class="ti-plus"></i></a>
    </div>
    ...
    <?php include 'addNewTaxesModal.php';?>
