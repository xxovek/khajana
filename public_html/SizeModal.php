    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control form-control-sm" id="SizeValue" name="SizeValue" onkeypress="return isNumberKey1(event);" data-placement="bottom" data-provide="tooltip" title="Size Value Example :400" required>
