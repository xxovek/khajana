...
jQuery.fn.hasDataAttr = function(a) {
    ...
    function(a, b) {
        var c = {
            name: "TheAdmin",
            version: "1.0.0",
            corejs: a('script[src*="core.min.js"]').attr("src")
        };
        c.dir = {
            home: c.corejs.replace("assets/js/core.min.js", ""),
            assets: c.corejs.replace("js/core.min.js", ""),
            vendor: c.corejs.replace("js/core.min.js", "vendor/")
        };
        var d = a("[data-assets-url]");
        if (d.length) {
            var e = d.data("assets-url");
            "/" !== e.slice(-1) && (e += "/"), c.dir.assets = e, c.dir.vendor = e + "vendor/"
        }
        c.defaults = {
            provide: null,
            googleApiKey: null,
        ...
        c.isReady = function() {
            ...
            if (a.extend(!0, c.defaults, d), c.defaults.provide && c.provide(c.defaults.provide), c.defaults.smoothscroll && c.provide("smoothscroll"), a('[data-provide~="map"]').length && void 0 === b["google.maps.Map"] && a.getScript("https://maps.googleapis.com/maps/api/js?key=" + c.defaults.googleApiKey + "&callback=app.map"), c.defaults.googleAnalyticsKey && (! function(a, b, c, d, e, f, g) {
                ...
                }(b, document, "script", 0, "ga"), ga("create", c.defaults.googleAnalyticsKey, "auto"), ga("send", "pageview")), c.defaults.saveState) {
                var e = c.state();
    ...
    function(a) {
        provider.list = {
          ...
          //       css: ["datatables/css/dataTables.bootstrap4.min.css","datatables/css/buttons.bootstrap4.min.css"],
    ...
    function(a, b) {
        ...
        c.init = function() {
            a(".quickview-body").perfectScrollbar(), a(document).on("shown.bs.tab", '.quickview-header a[data-toggle="tab"]', function(b) {
                ...
                0 == d ? c.close(a(this).closest(".quickview")) : c.toggle(d)
    ...
    function(a, b) {
        ...
        c.init = function() {
            a(document).on("click", ".card-btn-close", function() {
                a(this).parents(".card").fadeOut(600, function() {
                    1 == a(this).parent().children().length ? a(this).parent().remove() : a(this).remove()
                })
            }), a(document).on("click", ".card-btn-slide", function() {
                a(this).toggleClass("rotate-180").parents(".card").find(".card-content").slideToggle()
            }), a(document).on("click", ".card-btn-maximize", function() {
                a(this).parents(".card").toggleClass("card-maximize").removeClass("card-fullscreen")
            }), a(document).on("click", ".card-btn-fullscreen", function() {
                a(this).parents(".card").toggleClass("card-fullscreen").removeClass("card-maximize")
            }), a(document).on("click", ".card-btn-reload", function(b) {
                b.preventDefault();
                var c = a(this).attr("href"),
                    d = a(this).parents(".card");
