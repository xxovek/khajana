  ...
  $.ajax({
      ...
      success: function(msg) {
        ...
        for(n=0;n<count;n++){
          ...
          t +='<input type="text" class="form-control" value="1" data-provide="tooltip" data-placement="top"  title="Quantity in hand 0" id="qty'+(rows+1)+'" onchange="setamount('+(rows+1)+')" onkeypress="return isNumberInt(event);">';
...
function rowAgreg() {
   ...
   t +='<div class="col-sm-12">';
   t +='<div class="form-group">';
   t +='<input type="text" class="form-control" value="1" data-provide="tooltip" data-placement="top"  title="Quantity in hand 10" id="qty'+(rows+1)+'" onchange="setamount('+value+')" onkeypress="return isNumberInt(event);">';
   t +='<input type="hidden" id="hiddenqtyonhand'+(rows+1)+'">';
   t +='<input type="hidden" id="hiddenlowstockalert'+(rows+1)+'">';
  ...
  //  t +='</button>';
   ...
   connectitemtax(value);
     ...
     t +='<div class="col-sm-12">';
     t +='<div class="form-group">';
     t +='<input type="text" class="form-control"  value="1"  placeholder="QTY" id="qty'+(rows+1)+'" onchange="setamount('+value+')" data-provide="tooltip" data-placement="top"  title="Quantity in hand 0" onkeypress="return isNumberInt(event);">';
     t +='<input type="hidden" id="hiddenqtyonhand'+(rows+1)+'">';
     t +='<input type="hidden" id="hiddenlowstockalert'+(rows+1)+'">';
     // t +='<a data-toggle="collapse" data-parent="#accordion-1" href="#collapse'+(rows+1)+'" aria-expanded="false" class="collapsed">Check</a>';
     // t +='<div id="collapse'+(rows+1)+'" class="collapse" >';
